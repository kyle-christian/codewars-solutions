...
RESULTS:
enumerate from the first number to the last number
...
PSEUDOCODE:
set variables = to the first number and last number of the array and then use a for loop to enter it into a new array.

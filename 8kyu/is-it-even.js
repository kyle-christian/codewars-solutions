...
RESULTS:
return true or false based on whether the number is even or odd
...
PSEUDOCODE:
    ...
    - numbers may be positive/negative, integers/floats. Floats are considered uneven for this kata

*/

const testEven = n => Math.abs(n) % 2 === 0 ? true : false;
...
RESULTS:
return the appropriate greeting from the database
...
console.log(languages.estonian)
...
const greetAlt = language => languages[language] != undefined ? languages[language] : languages["english"]; 
